...
const Row = ({ title, movies }: Props) => {
	...
	return (
		<div className="h-40 space-y-0.5 md:space-y-2 md:my-20 my-8">
			<h2 className="w-55 cursor-pointer text-sm font-semibold text-[#e5e5e5] transition duration-200 hover:text-white md:text-2xl">
				{title}
			</h2>
